...
function Splash.RegisterNucleusAbility(Type, SpellID, Radius, Expansion)
  ...
  if (Expansion == "retail" and not HL.IsRetail) or (Expansion == "classic" and not HL.IsClassic) then
    return
  end
...
function Splash.RegisterNucleusAbilities() -- TODO: Add classic/cata support
  ...
  -- Death Knight
  -- Commons
  RegisterNucleusAbility("DirectDamage", 383313, 8, "retail")               -- Abomination Limb
  RegisterNucleusAbility("GroundDirectDamage", 52212, 8)                    -- Death and Decay
  -- Blood
  RegisterNucleusAbility("DirectDamage", 50842, 10)                         -- Blood Boil
  RegisterNucleusAbility("DirectDamage", 196528, 8, "retail")               -- Bonestorm
  RegisterNucleusAbility("DirectDamage", 274156, 8, "retail")               -- Consumption
  -- Frost
  RegisterNucleusAbility("DirectDamage", 155166, 12, "retail")              -- Breath of Sindragosa
  RegisterNucleusAbility("DirectDamage", 204167, 6, "retail")               -- Chill Streak
  RegisterNucleusAbility("DirectDamage", 207230, 8, "retail")               -- Frostscythe
  RegisterNucleusAbility("DirectDamage", 49184, 10)                         -- Howling Blast
  RegisterNucleusAbility("DirectDamage", 196771, 8, "retail")               -- Remorseless Winter
  -- Unholy
  RegisterNucleusAbility("GroundDirectDamage", 156000, 8, "retail")         -- Defile
  RegisterNucleusAbility("DirectDamage", 115994, 10, "retail")              -- Unholy Blight
  RegisterNucleusAbility("DirectDamage", 212739, 8, "retail")               -- Epidemic

  -- Demon Hunter
  -- Commons
  RegisterNucleusAbility("DirectDamage", 179057, 8, "retail")               -- Chaos Nova
  RegisterNucleusAbility("DirectDamage", 258922, 8, "retail")               -- Immolation Aura
  RegisterNucleusAbility("GroundDirectDamage", 307046, 8, "retail")         -- Elysian Decree
  RegisterNucleusAbility("GroundDirectDamage", 204598, 8, "retail")         -- Sigil of Flame
  -- Havoc
  RegisterNucleusAbility("DirectDamage", 200685, 8, "retail")               -- Blade Dance 1
  RegisterNucleusAbility("DirectDamage", 199552, 8, "retail")               -- Blade Dance 2
  RegisterNucleusAbility("DirectDamage", 210153, 8, "retail")               -- Death Sweep 1
  RegisterNucleusAbility("DirectDamage", 210155, 8, "retail")               -- Death Sweep 2
  RegisterNucleusAbility("DirectDamage", 258860, 10, "retail")              -- Essence Break
  RegisterNucleusAbility("DirectDamage", 198030, 20, "retail")              -- Eye Beam
  RegisterNucleusAbility("GroundDirectDamage", 200166, 8, "retail")         -- Metamorphosis
  -- Vengeance
  RegisterNucleusAbility("DirectDamage", 320341, 8, "retail")               -- Bulk Extraction
  RegisterNucleusAbility("DirectDamage", 212105, 13, "retail")              -- Fel Devastation
  RegisterNucleusAbility("DirectDamage", 189112, 6, "retail")               -- Infernal Strike
  RegisterNucleusAbility("DirectDamage", 228478, 8, "retail")               -- Soul Cleave
  RegisterNucleusAbility("DirectDamage", 247455, 8, "retail")               -- Spirit Bomb
  -- Druid
  -- Commons
  RegisterNucleusAbility("PeriodicDamage", 164815, 8, "retail")             -- Sunfire
  RegisterNucleusAbility("DirectDamage", 194153, 10, "retail")              -- Starfire
  -- Balance
  --RegisterNucleusAbility("TO_INVESTIGATE", 191037, 45)                    -- Starfall
  RegisterNucleusAbility("DirectDamage", 274283, 8, "retail")               -- New Moon/Full Moon
  RegisterNucleusAbility("DirectDamage", 88751, 8)                          -- Wild Mushroom
  -- Feral
  RegisterNucleusAbility("DirectDamage", 285381, 8, "retail")               -- Primal Wrath
  RegisterNucleusAbility("DirectDamage", 202028, 8, "retail")               -- Brutal Slash
  RegisterNucleusAbility("DirectDamage", 106830, 8, "retail")               -- Thrash (Cat)
  RegisterNucleusAbility("DirectDamage", 106785, 8, "retail")               -- Swipe (Cat)
  -- Guardian
  RegisterNucleusAbility("DirectDamage", 77758, 8)                          -- Thrash (Bear)
  RegisterNucleusAbility("DirectDamage", 213771, 8, "retail")               -- Swipe (Bear)
  -- Restoration

  -- Evoker
  -- Commons
  RegisterNucleusAbility("DirectDamage", 357209, 12, "retail")              -- Fire Breath (Check spell ID; Range? It's a cone up to 25y(?))
  -- Augmentation
  RegisterNucleusAbility("DirectDamage", 395160, 8, "retail")               -- Eruption
  RegisterNucleusAbility("DirectDamage", 396288, 6, "retail")               -- Upheaval (Range? Spell goes from 3/6/9/12y depending on empower level)
  RegisterNucleusAbility("GroundDirectDamage", 403631, 12, "retail")        -- Breath of Eons (Range? Spell range is 15-50y)
  -- Devastation
  RegisterNucleusAbility("DirectDamage", 357212, 8, "retail")               -- Pyre (Check spell ID)
  RegisterNucleusAbility("DirectDamage", 359077, 12, "retail")              -- Eternity Surge (Check spell ID; Range? Could technically be out to 25y)
  RegisterNucleusAbility("DirectDamage", 362969, 6, "retail")               -- Azure Strike (Check spell ID, as it could also be 355627)
  RegisterNucleusAbility("GroundDirectDamage", 369374, 8, "retail")         -- Firestorm (Check spell ID; Should be GroundMultipleDirectDamage?)
  RegisterNucleusAbility("GroundDirectDamage", 353759, 12, "retail")        -- Deep Breath (Check spell ID; Range? Spell range is listed 20-50y)
  -- Preservation
  -- Hunter
  -- Commons
  RegisterNucleusAbility("DirectDamage", 171454, 8, "retail")               -- Chimaera Shot 1
  RegisterNucleusAbility("DirectDamage", 171457, 8, "retail")               -- Chimaera Shot 2
  -- Beast Mastery
  RegisterNucleusAbility("DirectDamage", 2643, 8)                           -- Multi-Shot
  RegisterNucleusAbility("DirectDamage", 118459, 10, "retail")              -- Beast Cleave
  RegisterNucleusAbility("DirectDamage", 201754, 8, "retail")               -- Stomp
  -- Marksmanship
  RegisterNucleusAbility("DirectDamage", 257620, 10, "retail")              -- Multi-Shot
  RegisterNucleusAbility("GroundDirectDamage", 260247, 8, "retail")         -- Volley
  RegisterNucleusAbility("DirectDamage", 212680, 8, "retail")               -- ExplosiveShot
  -- Survival
  RegisterNucleusAbility("DirectDamage", 212436, 8, "retail")               -- Butchery
  RegisterNucleusAbility("DirectDamage", 187708, 8, "retail")               -- Carve
  RegisterNucleusAbility("DirectDamage", 259495, 8, "retail")               -- Bombs 1
  RegisterNucleusAbility("DirectDamage", 270335, 8, "retail")               -- Bombs 2
  RegisterNucleusAbility("DirectDamage", 270323, 8, "retail")               -- Bombs 3
  RegisterNucleusAbility("DirectDamage", 271045, 8, "retail")               -- Bombs 4
  -- Mage
  -- Arcane
  RegisterNucleusAbility("DirectDamage", 1449, 10)                          -- Arcane Explosion
  RegisterNucleusAbility("DirectDamage", 44425, 10)                         -- Arcane Barrage
  -- Fire
  RegisterNucleusAbility("DirectDamage", 157981, 8, "retail")               -- Blast Wave
  ...
  RegisterNucleusAbility("DirectDamage", 257542, 8, "retail")               -- Phoenix Flames
  --RegisterNucleusAbility("TO_INVESTIGATE", 12654, 8)                      -- AoE Ignite
  -- Frost
  RegisterNucleusAbility("GroundDirectDamage", 84721, 8)                    -- Frozen Orb
  RegisterNucleusAbility("GroundDirectDamage", 190357, 8, "retail")         -- Blizzard
  RegisterNucleusAbility("DirectDamage", 153596, 6, "retail")               -- Comet Storm
  RegisterNucleusAbility("DirectDamage", 120, 12)                           -- Cone of Cold
  RegisterNucleusAbility("DirectDamage", 228600, 8, "retail")               -- Glacial Spike
  RegisterNucleusAbility("DirectDamage", 148022, 8, "retail")               -- Icicle
  RegisterNucleusAbility("DirectDamage", 228598, 8, "retail")               -- Ice Lance
  RegisterNucleusAbility("DirectDamage", 122, 12)                           -- Frost Nova
  RegisterNucleusAbility("DirectDamage", 157997, 8, "retail")               -- Ice Nova

  -- Monk
  -- Brewmaster
  -- Windwalker
  RegisterNucleusAbility("DirectDamage", 113656, 8, "retail")               -- Fists of Fury
  RegisterNucleusAbility("DirectDamage", 101546, 8, "retail")               -- Spinning Crane Kick
  RegisterNucleusAbility("DirectDamage", 261715, 8, "retail")               -- Rushing Jade Wind
  RegisterNucleusAbility("DirectDamage", 152175, 8, "retail")               -- Whirling Dragon Punch
  ...
  RegisterNucleusAbility("GroundDirectDamage", 343721, 8, "retail")         -- Final Reckoning
  RegisterNucleusAbility("DirectDamage", 385816, 8, "retail")               -- Incandescence

  -- Priest
  -- Discipline
  -- Holy
  -- Shadow
  RegisterNucleusAbility("DirectDamage", 205386, 8, "retail")               -- Shadow Crash
  RegisterNucleusAbility("DirectDamage", 228360, 10, "retail")              -- Void Eruption 1
  RegisterNucleusAbility("DirectDamage", 228361, 10, "retail")              -- Void Eruption 2
  RegisterNucleusAbility("DirectDamage", 394979, 10, "retail")              -- Mind Sear (Void Lasher)
  RegisterNucleusAbility("DirectDamage", 373279, 10, "retail")              -- Void Spike (Thing From Beyond)

  -- Rogue
  -- Assassination
  RegisterNucleusAbility("DirectDamage", 121411, 10, "retail")              -- Crimson Tempest
  RegisterNucleusAbility("DirectDamage", 51723, 10)                         -- Fan of Knives
  RegisterNucleusAbility("DirectDamage", 255546, 6, "retail")               -- Poison Bomb
  -- Outlaw
  RegisterNucleusAbility("DirectDamage", 22482, 6)                          -- Blade Flurry
  RegisterNucleusAbility("DirectDamage", 271881, 8, "retail")               -- Blade Rush
  -- Subtlety
  RegisterNucleusAbility("DirectDamage", 197835, 10, "retail")              -- Shuriken Storm
  RegisterNucleusAbility("DirectDamage", 282449, 10, "retail")              -- Secret Technique
  RegisterNucleusAbility("DirectDamage", 319175, 10, "retail")              -- Black Powder
  -- Shaman
  -- Elemental
  RegisterNucleusAbility("DirectDamage", 77478, 8)                          -- Earthquake
  RegisterNucleusAbility("DirectDamage", 188443, 10, "retail")              -- Chain Lightning
  RegisterNucleusAbility("DirectDamage", 192231, 9, "retail")               -- Liquid Magma Totem
  RegisterNucleusAbility("DirectDamage", 383061, 9, "retail")               -- Liquid Magma Totem 2
  RegisterNucleusAbility("DirectDamage", 452201, 8, "retail")               -- Tempest
  -- Enhancement
  RegisterNucleusAbility("DirectDamage", 187874, 8, "retail")               -- Crash Lightning
  RegisterNucleusAbility("DirectDamage", 197214, 11, "retail")              -- Sundering
  -- Restoration
  ...
  RegisterNucleusAbility("GroundDirectDamage", 386609, 8, "retail")         -- Guillotine's Fel Explosion
  RegisterNucleusAbility("DirectDamage", 86040, 8)                          -- Hand of Gul'dan
  RegisterNucleusAbility("DirectDamage", 196278, 8, "retail")               -- Implosion
  -- Destruction
  RegisterNucleusAbility("GroundDirectDamage", 152108, 8, "retail")         -- Cataclysm
  RegisterNucleusAbility("DirectDamage", 387547, 8, "retail")               -- Cry Havoc
  ...
  -- Warrior
  -- Commons
  RegisterNucleusAbility("GroundDirectDamage", 156287, 8, "retail")         -- Ravager
  RegisterNucleusAbility("DirectDamage", 396719, 8, "retail")               -- Thunder Clap
  RegisterNucleusAbility("DirectDamage", 384318, 12, "retail")              -- Thunderous Roar
  RegisterNucleusAbility("DirectDamage", 199658, 8, "retail")               -- Whirlwind
  -- Arms
  RegisterNucleusAbility("DirectDamage", 50622, 8)                          -- Bladestorm
  RegisterNucleusAbility("DirectDamage", 845, 8)                            -- Cleave
  RegisterNucleusAbility("DirectDamage", 262161, 8, "retail")               -- Warbreaker
  RegisterNucleusAbility("DirectDamage", 1680, 8)                           -- Whirlwind
  -- Fury
  RegisterNucleusAbility("DirectDamage", 385061, 12, "retail")              -- Odyn's Fury
  RegisterNucleusAbility("DirectDamage", 385062, 12, "retail")              -- Odyn's Fury also (offhand?)
  -- Protection
